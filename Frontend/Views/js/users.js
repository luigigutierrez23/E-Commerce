...
$("#regEmail").change(function(){
	...
	$.ajax({
		...
		url:rutaOculta+"Ajax/users.ajax.php",
		method: "POST",
		data: datos,
		cache: false,
		contentType: false,
...
function registroUsuario(){
	...
	/*====================================
	=  VALIDAR TERMINOS DE PRIVACIDAD    =
	======================================*/
		...
		swal({
			  ...
			  function(isConfirm){
			  	...
			  	if(isConfirm){
					...
					window.location = rutaOculta+"profile";
			  	}
			  }
			); 	
...
$("#eliminarUsuario").click(function() {
	...
	swal({
		  title: "¿Esta usted seguro(a) de eliminar su cuenta?",
		  text: "¡Si borra esta cuenta ya no se podran recuperar los datos!",
		  type: "warning",
		...
		function(isConfirm){
				 if (isConfirm) {	   
				    window.location = "index.php?url=profile&id="+id+"&foto="+foto;
				  } 
		});
});