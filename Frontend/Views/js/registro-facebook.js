			...
			$.ajax({
				...
				success:function(respuesta){
					...
					else
					{
						swal({
							  title: "¡ERROR!",
							  text: "¡El correo electrónico "+email+" ya esta registrado con un metodo diferente a Facebook!",
							  type: "error",
							  confirmButtonText: "Cerrar",
							  closeOnConfirm: false
							}, 
									...
									FB.getLoginStatus(function(response){
										...
										if(response.status == 'connected'){
											...
											FB.logout(function(response){
												...
												deleteCookie("fblo_657614951752272");

												setTimeout(function(){

													window.location = rutaOculta+"exit";
