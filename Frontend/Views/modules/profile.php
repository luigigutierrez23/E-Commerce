	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
		  ...
		  <li>
	  		...
	  		<i class="fa fa-gift"></i> LISTA DE DESEOS</a>
		  </li>
		  ...
		  <li>
    		<a data-toggle="tab" href="<?php echo $url ?>offers">
			  					...
			  					echo ' <div class="panel panel-default">
									   	   ...
									   	   <div class="panel-body">
												...
												<div class="col-sm-6 col-xs-12">
										    		...
										    		if($value2["tipo"] == "virtual"){
										    			...
										    			echo '<a href="'.$url.'curso">
																...
																<button class="btn btn-default pull-left backColor">Ir al curso</button>
										    				</a>';
										    		}else{

										    			echo'<h6> Proceso de entrega: '.$value2["entrega"].' días habiles </h6>';
										    		...
										    		echo' <h4 class="pull-right"><small>Comprado el '.substr($value1["timestamp"],0,-8).'</small></h4>
										    	...
										    	echo'<div class="pull-right">';
														...
														echo'<a href="#modalComentarios" class="calificarProducto" data-toggle="modal" idComentario="'.$comentarios["id"].'">';
													

														echo'<button class="btn btn-default backColor">Calificar Producto</button>
													...
													<div class="pull-right">
														...
														<h4 class="text-right">';
																...
																if(empty($comentarios["calificacion"]) && empty($comentarios["comentario"])){
																	...
																	echo'<i class="fa fa-star-o text-success" aria-hidden="true"></i>
																		...
																		<p class="panel panel-default" style="padding:5px"><small></small></p>
																	...
																	echo'</h4>
																		...
																		<p class="panel panel-default text-right" style="padding:5px"><small>'.$comentarios["comentario"].'</small></p>
			    ...
			    <?php 
			    	...
			    	if(!($deseos)){
			    		...
			    		echo '<div class="col-xs-12 text-center error404">
			  					...
			  					<h2>Aún no tiene lista de deseos</h2>
						 	...
						 	foreach ($productos as $key => $value2) 
							{
								echo '<li class="col-md-3 col-sm-6 col-xs-12">
										...
										<figure>
											...
											<a href="'.$url.$value2["url"].'" class="pixelProducto">
											...
											<small>
												...
												<a href="'.$url.$value2["url"].'" class="pixelProducto">
													...
													if($value2["oferta"] != 0){
														...
														echo'<span class="label label-warning fontSize">'.$value2["descuento_oferta"].'% off</span> ';
													}
											...
											if($value2["oferta"] != 0){
												...
												echo'<h2 style="margin-top: -10px">
														...
														<small>
															...
															<strong class="oferta" style="font-size:10px">USD $'.$value2["precio"].'</strong>

														</small>

														<small>$'.$value2["precio_oferta"].'</small>
									...
									<div class="col-xs-6 enlaces">
										...
										<div class="btn-group pull-right">
											...
											if($value2["tipo"] == "virtual" && $value2["precio"] != 0)
											{
												if($value2["oferta"] != 0)
												{
													echo '<button type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="'.$value2["id"].'" imagen="'.$servidor.$value2["portada"].'" titulo="'.$value2["titulo"].'" precio="'.$value2["precio_oferta"].'" tipo="'.$value2["tipo"].'" peso="'.$value2["peso"].'" data-toggle="tooltip" title="Agregar al carrito de compras">
										    ...
										    echo'<a href="'.$url.$value2["url"].'" class="pixelProducto">
			    ...
			    <div class="row">
					...
					<form method="post" enctype="multipart/form-data">
						...
						<div class="col-md-3 col-sm-4 col-xs-12 text-center">
							...
							<?php 
								...
								if($_SESSION["modo"] == "directo"){
									...
									echo'<button type="button" class="btn btn-default backColor" id="btnCambiarFoto">
							...
							<?php 
								...
								if($_SESSION["modo"] != "directo"){
									...
									echo '<br>
										...
										<label class="control-label text-uppercase">Nombre:</label>
										...
										<label class="control-label text-uppercase">Correo electrónico:</label>
										...
										<label class="control-label text-uppercase">Modo de registro en el sistema</label>
									...
									echo '<br>
										...
										<div class="input-group">
											...
											<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
											<input type="text" class="form-control" name="editarNombre" id="editarNombre" value="'.$_SESSION["nombre"].'">
										</div>
										...
										<div class="input-group">
											...
											<input type="text" class="form-control" name="editarEmail" id="editarEmail" value="'.$_SESSION["email"].'">
										...
										<div class="input-group">
											...
											<input type="text" class="form-control" name="editarPassword" id="editarPassword" placeholder="Escribe la nueva contraseña">
						...
						<?php 
							...
							$actulizarPerfil = new ControladorUsuarios();
							$actulizarPerfil-> ctrActualizarPerfil();
	...
	<div class="modal-content modal-dialog">
		...
		<div class="modal-body modalTitulo">
			...
			<form  method="post" onsubmit="return validarComentario()">
				...
				<input type="hidden" value="" name="idComentario" id="idComentario">
				...
				<div class="form-group">
					...
					<label for="comment" class="text-muted">Tu opinion acerca de este producto:<span><small>(máximo 300 caracteres)</small></span></label>
					
					<textarea class="form-control" rows="5" id="comentario" name="comentario" maxlength="300"></textarea>
