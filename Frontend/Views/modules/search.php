			 		...
			 		foreach ($productos as $key => $value) 
						{
							echo '<li class="col-md-3 col-sm-6 col-xs-12">
									...
									<figure>
										...
										<a href="'.$value["url"].'" class="pixelProducto">
								...
								echo'</div>
									...
									<div class="col-xs-6 enlaces">
									    ...
									    echo'<a href="'.$value["url"].'" class="pixelProducto">
			...
			<center>
				...
				<?php
					...
					if(!empty($listaProductos)){
						...
						$cantidad = count($listaProductos);
						$pagProductos =  ceil(($cantidad/12));
						
							if($pagProductos > 4){

							/*=============================================
							= BOTONES DE LAS PRIMERAS 4 PAG Y LA ULTIMA PAG =
							=============================================*/
							...
							/*=============================================
							= BOTONES DE LAS MITAD DE PAGINAS HACIA ABAJO =
							=============================================*/
							...
							/*=============================================
							= BOTONES DE LAS MITAD DE PAGINAS HACIA ARRIBA =
							=============================================*/
							...
							/*=============================================
							= BOTONES DE LAS ULTIMAS 4 PAG Y LA PRIMERA PAG =
							=============================================*/
							else{
